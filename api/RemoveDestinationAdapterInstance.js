// Vercel Serverless Function to proxy RemoveDestinationAdapterInstance to Azure Functions
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Error proxying RemoveDestinationAdapterInstance:', error);
    res.status(500).json({ 
      error: 'Proxy error', 
