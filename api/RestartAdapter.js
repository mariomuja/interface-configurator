// Vercel Serverless Function to proxy RestartAdapter to Azure Functions
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const url = `${functionAppUrl.replace(/\/$/, '')}/api/RestartAdapter`;
    ...
    console.error('Error proxying RestartAdapter:', error);
    res.status(500).json({ 
      error: 'Proxy error', 
