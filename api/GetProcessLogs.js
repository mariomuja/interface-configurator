// Vercel Serverless Function to proxy GetProcessLogs to Azure Functions
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const url = `${functionAppUrl.replace(/\/$/, '')}/api/GetProcessLogs`;
    ...
    console.error('Error proxying GetProcessLogs:', error);
    res.status(500).json({ 
      error: 'Proxy error', 
