...
public class UpdateSourceAdapterInstance
{
    private readonly IInterfaceConfigurationService _configService;
    private readonly IContainerAppService _containerAppService;
    private readonly ILogger<UpdateSourceAdapterInstance> _logger;

    public UpdateSourceAdapterInstance(
        IInterfaceConfigurationService configService,
        IContainerAppService containerAppService,
        ILogger<UpdateSourceAdapterInstance> logger)
    {
    ...
    [Function("UpdateSourceAdapterInstance")]
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", "options", Route = "UpdateSourceAdapterInstance")] HttpRequestData req,
        FunctionContext executionContext)
    {
        _logger.LogInformation("UpdateSourceAdapterInstance function triggered");
        ...
        try
        {
            ...
            var request = JsonSerializer.Deserialize<UpdateSourceAdapterInstanceRequest>(requestBody, new JsonSerializerOptions
            {
            ...
            await _configService.UpdateSourceAdapterInstanceAsync(
            ...
            _logger.LogInformation("Updated source adapter instance '{AdapterInstanceGuid}' in interface '{InterfaceName}'", 
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        var config = await _configService.GetConfigurationAsync(request.InterfaceName, executionContext.CancellationToken);
                        var instance = config?.Sources.Values.FirstOrDefault(s => s.AdapterInstanceGuid == request.AdapterInstanceGuid);
                        if (instance != null)
                        {
            ...
            await response.WriteStringAsync(JsonSerializer.Serialize(new { 
                message = $"Source adapter instance '{request.AdapterInstanceGuid}' updated successfully.",
        ...
        {
            _logger.LogWarning(ex, "Source adapter instance not found");
        ...
        {
            _logger.LogError(ex, "Error updating source adapter instance");
    ...
    private class UpdateSourceAdapterInstanceRequest
    {
