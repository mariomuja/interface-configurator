...
public class UpdateDestinationFileMask
{
    ...
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Function, "put", Route = "UpdateDestinationFileMask")] HttpRequestData req,
        FunctionContext executionContext)
    {
        ...
        try
        {
            ...
            var request = JsonSerializer.Deserialize<UpdateDestinationFileMaskRequest>(requestBody);
