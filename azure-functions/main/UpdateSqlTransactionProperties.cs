...
public class UpdateSqlTransactionProperties
{
    ...
    public async Task<HttpResponseData> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", "options", Route = "UpdateSqlTransactionProperties")] HttpRequestData req,
        FunctionContext executionContext)
    {
        ...
        try
        {
            ...
            var request = JsonSerializer.Deserialize<UpdateSqlTransactionPropertiesRequest>(requestBody, new JsonSerializerOptions
            {
