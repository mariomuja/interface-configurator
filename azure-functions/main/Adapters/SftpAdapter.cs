...
public class SftpAdapter : IAdapter
{
    ...
    public bool SupportsWrite => false; // SFTP adapter is read-only
    ...
    /// <summary>
    /// IAdapter.WriteAsync implementation - not supported for SFTP adapter
    /// </summary>
    public Task WriteAsync(string destination, List<string> headers, List<Dictionary<string, string>> records, CancellationToken cancellationToken = default)
    {
