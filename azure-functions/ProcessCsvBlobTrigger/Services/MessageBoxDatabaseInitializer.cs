...
public class MessageBoxDatabaseInitializer : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        try
        {
            ...
            if (created)
            {
                _logger.LogInformation("MessageBox database and tables created successfully. Tables: Messages, MessageSubscriptions, ProcessLogs");
            }
            else
            {
                _logger.LogInformation("MessageBox database and tables already exist. Tables: Messages, MessageSubscriptions, ProcessLogs");
            }
        }
