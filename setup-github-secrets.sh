...
if ! command -v gh &> /dev/null; then
    ...
    echo "  Oder setze die Secrets manuell über: https://github.com/mariomuja/interface-configurator/settings/secrets/actions"
    exit 1
fi
...
echo "  1. Teste den Workflow: https://github.com/mariomuja/interface-configurator/actions"
